                                    ...
                                    @foreach ($blog as $bg)
                                        <div class="col-6">
                                            ...
                                            <article>
                                                ...
                                                <div class="post-img">
                                                    <img src="{{ url('/default/blogs/' . $bg->image) }}" alt=""
                                                        class="img-fluid"
                                                ...
                                                <h2 class="title">
                                                    <a
                                                        href="{{ route('frontend.blog-detail', $bg->id) }}">{{ Str::words($bg->name, 10) }}</a>
                                                </h2>
                                                ...
                                                <div class="meta-top">
                                                    <ul>
                                                        <li class="d-flex align-items-center"><i
                                                                ...
                                                                href="blog-details.html">{{ $bg->user->name }}</a>
                                                        </li>
                                                        <li class="d-flex align-items-center"><i
                                                                class="bi bi-clock"></i> <a
                                                                href="blog-details.html"><time
                                                                    datetime="2022-01-01">{{ \Carbon\Carbon::parse($bg->created_at)->format('d M Y') }}</time></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </article>
