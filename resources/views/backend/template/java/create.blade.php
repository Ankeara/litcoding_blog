        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="POST" action="{{ route('template.java.save') }}" id="JavaForm" name="JavaForm"
                            ...
                            <div class="row">
                                <div class="card-body col-6 col-lg-6 col-md-12 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="title_video_java"
                                                id="title_video_java">
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="video_java" id="video_java"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_video_java" id="description_video_java"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="header_java" id="header_java">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Description java one</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_one" id="description_java_one"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description java two</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_two" id="description_java_two"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_tree" id="description_java_tree"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_four" id="description_java_four"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-body col-6 col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_five" id="description_java_five"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_six" id="description_java_six"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_seven" id="description_java_seven"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_eight" id="description_java_eight"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_nine" id="description_java_nine"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_java_ten" id="description_java_ten"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === true) {
                            ...
                            if (errors.header_java) {
                                $('#header_java').addClass("is-invalid").siblings('p').addClass(
                                        "invalid-feedback")
                                    .html(errors.header_java)
                            } else {
                                $('#header_java').removeClass("is-invalid").siblings('p').removeClass(
                                        "invalid-feedback")
                                    .html('')
                            }
                        }
