        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="POST" action="{{ route('template.javascript.save') }}" id="javascriptForm"
                            name="javascriptForm" enctype="multipart/form-data">
                            @csrf
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4>Create JavaScript</h4>
                            ...
                            <div class="row">
                                <div class="card-body col-6 col-lg-6 col-md-12 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="title_video_js"
                                                id="title_video_js">
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="video_js" id="video_js">
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_video_js" id="description_video_js"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        <label>Header JavaScript</label>
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="header_js" id="header_js">
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_js_one" id="description_js_one"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="codeeditor" name="html_code" id="html_code"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                </div>
                                <div class="card-body col-6 col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_css" id="description_css"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="codeeditor" name="css_code" id="css_code"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_js" id="description_js"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        <label>JavaScript Code</label>
                                        <div class="form-controller">
                                            <textarea class="codeeditor" name="js_code" id="js_code"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
...
@section('customJS')
    <script>
        $("#javascriptForm").submit(function(e) {
            e.preventDefault();
