        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="POST" action="{{ route('template.html.save') }}" id="htmlForm" name="htmlForm"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4>Create HTML CSS</h4>
                            ...
                            <div class="row">
                                <div class="card-body col-6 col-lg-6 col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <p class="text-danger" id="title-warning" style="display:none;">Please enter title
                                            project</p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="title_video_html"
                                                id="title_video_html">
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="video_html" id="video_html"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_video_html" id="description_video_html"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="header_html" id="header_html">
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_html" id="description_html"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
