...
@section('main_admin')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Form Flutter</h2>
            <p class="section-lead">
                Form Flutter using default from Bootstrap 4
            </p>

            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="POST" action="{{ route('template.flutter.save') }}" id="flutterForm"
                            name="flutterForm" enctype="multipart/form-data">
                            @csrf
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4>Create Flutter</h4>
                                <a href="{{ route('template.flutter.view') }}" class="btn btn-primary btn-sm">Go Back</a>
                            </div>
                            <div class="row">
                                <div class="card-body col-6 col-lg-6 col-md-12 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="title_video_flutter"
                                                id="title_video_flutter">
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="video_flutter" id="video_flutter"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_video_flutter" id="description_video_flutter"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        <label>Header flutter</label>
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="header_flutter"
                                                id="header_flutter">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Description flutter one</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_one" id="description_flutter_one"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description flutter two</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_two" id="description_flutter_two"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description flutter tree</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_tree" id="description_flutter_tree"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description flutter four</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_four" id="description_flutter_four"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-body col-6 col-lg-6 col-md-12">
                                    <div class="form-group">
                                        <label>Description flutter five</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_five" id="description_flutter_five"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description flutter six</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_six" id="description_flutter_six"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description flutter seven</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_seven" id="description_flutter_seven"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description flutter eight</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_eight" id="description_flutter_eight"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description flutter nine</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_nine" id="description_flutter_nine"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description flutter ten</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_flutter_ten" id="description_flutter_ten"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                    ...
                    success: function(response) {
                        if (response.status === true) {
                            ...
                            $('#title').removeClass("is-invalid").siblings('p').removeClass(
                                    "invalid-feedback")
                                .html('')
                            window.location.href = "{{ route('template.flutter.view') }}";
                        } else {
                            ...
                            if (errors.header_flutter) {
                                $('#header_flutter').addClass("is-invalid").siblings('p').addClass(
                                        "invalid-feedback")
                                    .html(errors.header_flutter)
                            } else {
                                $('#header_flutter').removeClass("is-invalid").siblings('p')
                                    .removeClass(
                                        "invalid-feedback")
                                    .html('')
                            }
