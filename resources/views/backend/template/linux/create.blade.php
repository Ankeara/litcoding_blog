        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form method="POST" action="{{ route('template.linux.save') }}" id="linuxForm" name="linuxForm"
                            ...
                            <div class="row">
                                <div class="card-body col-6 col-lg-6 col-md-12 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="title_video_linux"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="video_linux" id="video_linux"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_video_linux" id="description_video_linux"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <input type="text" class="form-control" name="header_linux"
                                                id="header_linux">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_linux_one" id="description_linux_one"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description Linux</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_linux_two" id="description_linux_two"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-body col-6 col-lg-6 col-md-12">
                                    <div class="form-group">
                                        <label>Description Linux</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_linux_tree" id="description_linux_tree"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description Linux</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_linux_four" id="description_linux_four"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description Linux</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_linux_five" id="description_linux_five"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Description Linux</label>
                                        <div class="form-controller">
                                            <textarea class="textarea" name="description_linux_six" id="description_linux_six"></textarea>
                                        </div>
                                        <p></p>
                                    </div>
                                    <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === true) {
                            ...
                            if (errors.header_linux) {
                                $('#header_linux').addClass("is-invalid").siblings('p').addClass(
                                        "invalid-feedback")
                                    .html(errors.header_linux)
                            } else {
                                $('#header_linux').removeClass("is-invalid").siblings('p').removeClass(
                                        "invalid-feedback")
                                    .html('')
                            }
                        }
