                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="{{ route('blog-post.blog.view') }}" class="btn btn-primary">View All</a>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="font-weight-600"><img
                                                            src="{{ url('/profile/' . $bg->user->image) }}" alt="avatar"
                            ...
                            @foreach ($users as $item)
                                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="{{ url('/profile/', $item->image) }}" class="img-fluid"
